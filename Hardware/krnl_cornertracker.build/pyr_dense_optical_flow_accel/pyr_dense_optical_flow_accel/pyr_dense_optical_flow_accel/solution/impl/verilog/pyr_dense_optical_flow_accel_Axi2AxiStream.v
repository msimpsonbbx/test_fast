...
module pyr_dense_optical_flow_accel_Axi2AxiStream (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    din_blk_n;
reg   [21:0] empty_379_reg_96;
reg    ap_block_state1;
wire   [0:0] icmp_ln882_fu_107_p2;
reg   [63:0] gmem3_addr_reg_158;
...
assign add_ln695_fu_142_p2 = (empty_379_reg_96 + 22'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1003_reg_169 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem3_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1003_reg_169 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem3_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1003_reg_169 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem3_RVALID == 1'b0)));
end
...
always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = ((icmp_ln1003_reg_169 == 1'd0) & (m_axi_gmem3_RVALID == 1'b0));
end
...
assign icmp_ln1003_fu_137_p2 = ((empty_379_reg_96 == addrbound_V_read) ? 1'b1 : 1'b0);

assign icmp_ln882_fu_107_p2 = ((addrbound_V_read == 22'd0) ? 1'b1 : 1'b0);

assign ldata1_din = gmem3_addr_read_reg_178;

assign m_axi_gmem3_ARADDR = gmem3_addr_reg_158;
...
assign m_axi_gmem3_ARLEN = addrbound_V_read;
...
endmodule //pyr_dense_optical_flow_accel_Axi2AxiStream
