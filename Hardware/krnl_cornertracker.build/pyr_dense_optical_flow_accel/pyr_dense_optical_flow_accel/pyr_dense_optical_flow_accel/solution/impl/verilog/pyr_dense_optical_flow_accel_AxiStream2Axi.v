...
module pyr_dense_optical_flow_accel_AxiStream2Axi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln1305_reg_171;
reg    gmem4_blk_n_AW;
wire    ap_CS_fsm_state2;
reg    gmem4_blk_n_W;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln1305_reg_171_pp0_iter1_reg;
reg    gmem4_blk_n_B;
wire    ap_CS_fsm_state73;
reg   [0:0] icmp_ln882_reg_161;
reg    dout_blk_n;
reg   [21:0] empty_358_reg_103;
reg    ap_block_state1;
wire   [0:0] icmp_ln882_fu_114_p2;
reg   [63:0] gmem4_addr_reg_165;
wire   [0:0] icmp_ln1305_fu_144_p2;
wire    ap_block_state3_pp0_stage0_iter0;
reg    ap_block_state4_pp0_stage0_iter1;
wire    ap_block_state5_pp0_stage0_iter2;
reg    ap_block_state5_io;
reg    ap_block_pp0_stage0_11001;
wire   [21:0] add_ln695_fu_149_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [31:0] ldata1_read_reg_180;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
wire  signed [63:0] sext_ln1305_fu_130_p1;
reg    ap_block_state73;
reg    ap_block_pp0_stage0_01001;
wire   [61:0] trunc_ln_fu_120_p4;
reg   [70:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((icmp_ln882_reg_161 == 1'd0) & (m_axi_gmem4_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (m_axi_gmem4_AWREADY == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1305_fu_144_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        empty_358_reg_103 <= add_ln695_fu_149_p2;
    end else if (((1'b1 == ap_CS_fsm_state2) & (m_axi_gmem4_AWREADY == 1'b1))) begin
        empty_358_reg_103 <= 22'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (dout_empty_n == 1'b0)) & (icmp_ln882_fu_114_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1305_reg_171 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ldata1_read_reg_180 <= ldata1_dout;
    end
end

always @ (*) begin
    if ((icmp_ln1305_fu_144_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((icmp_ln882_reg_161 == 1'd0) & (m_axi_gmem4_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state73) & (icmp_ln882_reg_161 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln1305_reg_171_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1305_reg_171 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1305_reg_171 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        ldata1_read = 1'b1;
    end else begin
        ldata1_read = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (m_axi_gmem4_AWREADY == 1'b1))) begin
...
always @ (*) begin
    if ((~((icmp_ln882_reg_161 == 1'd0) & (m_axi_gmem4_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73) & (icmp_ln882_reg_161 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln1305_reg_171_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (dout_empty_n == 1'b0)) & (icmp_ln882_fu_114_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state73;
            end else if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (dout_empty_n == 1'b0)) & (icmp_ln882_fu_114_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1305_fu_144_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1305_fu_144_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign add_ln695_fu_149_p2 = (empty_358_reg_103 + 22'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ldata1_empty_n == 1'b0) & (icmp_ln1305_reg_171 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ldata1_empty_n == 1'b0) & (icmp_ln1305_reg_171 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ldata1_empty_n == 1'b0) & (icmp_ln1305_reg_171 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((ldata1_empty_n == 1'b0) & (icmp_ln1305_reg_171 == 1'd0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln1305_reg_171_pp0_iter1_reg == 1'd0) & (m_axi_gmem4_WREADY == 1'b0));
end

assign ap_block_state5_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state73 = ((icmp_ln882_reg_161 == 1'd0) & (m_axi_gmem4_BVALID == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign icmp_ln1305_fu_144_p2 = ((empty_358_reg_103 == addrbound_V_read) ? 1'b1 : 1'b0);

assign icmp_ln882_fu_114_p2 = ((addrbound_V_read == 22'd0) ? 1'b1 : 1'b0);
...
assign m_axi_gmem4_AWADDR = gmem4_addr_reg_165;
...
assign m_axi_gmem4_AWLEN = addrbound_V_read;
...
assign m_axi_gmem4_WDATA = ldata1_read_reg_180;
...
assign sext_ln1305_fu_130_p1 = $signed(trunc_ln_fu_120_p4);

assign trunc_ln_fu_120_p4 = {{dout_dout[63:2]}};

endmodule //pyr_dense_optical_flow_accel_AxiStream2Axi
