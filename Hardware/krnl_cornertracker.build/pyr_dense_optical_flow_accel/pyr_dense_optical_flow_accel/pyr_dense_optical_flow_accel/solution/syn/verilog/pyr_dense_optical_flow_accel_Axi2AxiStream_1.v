...
module pyr_dense_optical_flow_accel_Axi2AxiStream_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln1003_reg_169;
reg    ldata1_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln1003_reg_169_pp0_iter1_reg;
reg    din_blk_n;
reg   [19:0] empty_378_reg_96;
reg    ap_block_state1;
wire   [0:0] icmp_ln882_fu_107_p2;
reg   [63:0] gmem1_addr_reg_158;
wire   [0:0] icmp_ln1003_fu_137_p2;
wire    ap_block_state72_pp0_stage0_iter0;
reg    ap_block_state73_pp0_stage0_iter1;
reg    ap_block_state74_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
wire   [19:0] add_ln695_fu_142_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [31:0] gmem1_addr_read_reg_178;
wire    ap_CS_fsm_state71;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state72;
wire  signed [63:0] sext_ln1003_fu_123_p1;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1003_fu_137_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        empty_378_reg_96 <= add_ln695_fu_142_p2;
    end else if ((1'b1 == ap_CS_fsm_state71)) begin
        empty_378_reg_96 <= 20'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1003_reg_169 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        gmem1_addr_read_reg_178 <= m_axi_gmem1_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (din_empty_n == 1'b0)) & (icmp_ln882_fu_107_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((icmp_ln1003_fu_137_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1003_reg_169 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ldata1_write = 1'b1;
    end else begin
        ldata1_write = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1003_reg_169 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (din_empty_n == 1'b0)) & (icmp_ln882_fu_107_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state75;
            end else if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (din_empty_n == 1'b0)) & (icmp_ln882_fu_107_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1003_fu_137_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1003_fu_137_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state75;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
assign add_ln695_fu_142_p2 = (empty_378_reg_96 + 20'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1003_reg_169 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1003_reg_169 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (ldata1_full_n == 1'b0)) | ((icmp_ln1003_reg_169 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem1_RVALID == 1'b0)));
end
...
always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = ((icmp_ln1003_reg_169 == 1'd0) & (m_axi_gmem1_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state74_pp0_stage0_iter2 = ((icmp_ln1003_reg_169_pp0_iter1_reg == 1'd0) & (ldata1_full_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign icmp_ln1003_fu_137_p2 = ((empty_378_reg_96 == addrbound_V_read) ? 1'b1 : 1'b0);

assign icmp_ln882_fu_107_p2 = ((addrbound_V_read == 20'd0) ? 1'b1 : 1'b0);

assign ldata1_din = gmem1_addr_read_reg_178;

assign m_axi_gmem1_ARADDR = gmem1_addr_reg_158;
...
assign m_axi_gmem1_ARLEN = addrbound_V_read;
...
assign sext_ln1003_fu_123_p1 = $signed(trunc_ln_fu_113_p4);

assign trunc_ln_fu_113_p4 = {{din_dout[63:2]}};

endmodule //pyr_dense_optical_flow_accel_Axi2AxiStream_1
