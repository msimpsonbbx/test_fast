...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_srcPtr \
    op interface \
    ports { srcPtr_dout { I 64 vector } srcPtr_empty_n { I 1 bit } srcPtr_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dstMat_1_dout { I 32 vector } dstMat_1_empty_n { I 1 bit } dstMat_1_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dstMat_2_dout { I 32 vector } dstMat_2_empty_n { I 1 bit } dstMat_2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dstMat_1_out \
    op interface \
    ports { dstMat_1_out_din { O 32 vector } dstMat_1_out_full_n { I 1 bit } dstMat_1_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dstMat_2_out \
    op interface \
    ports { dstMat_2_out_din { O 32 vector } dstMat_2_out_full_n { I 1 bit } dstMat_2_out_write { O 1 bit } } \
} "
}
