...
set id 536
set name pyr_dense_optical_flow_accel_mul_32ns_32ns_64_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ldata1 \
    op interface \
    ports { ldata1_din { O 32 vector } ldata1_full_n { I 1 bit } ldata1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { last_blk_width { I 6 vector } } \
} "
}
