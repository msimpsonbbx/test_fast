...
entity pyr_dense_optical_flow_accel_Axi2AxiStream_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pyr_dense_optical_flow_accel_Axi2AxiStream_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1003_reg_169 : STD_LOGIC_VECTOR (0 downto 0);
    signal ldata1_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal icmp_ln1003_reg_169_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal din_blk_n : STD_LOGIC;
    signal empty_378_reg_96 : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal icmp_ln882_fu_107_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem1_addr_reg_158 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln1003_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln695_fu_142_p2 : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal gmem1_addr_read_reg_178 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state71 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state71 : signal is "none";
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state72 : STD_LOGIC;
    signal sext_ln1003_fu_123_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal trunc_ln_fu_113_p4 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
    ...
    empty_378_reg_96_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1003_fu_137_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                empty_378_reg_96 <= add_ln695_fu_142_p2;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state71)) then 
                empty_378_reg_96 <= ap_const_lv20_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1003_reg_169 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                gmem1_addr_read_reg_178 <= m_axi_gmem1_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (din_empty_n = ap_const_logic_0))) and (icmp_ln882_fu_107_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                gmem1_addr_reg_158 <= sext_ln1003_fu_123_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln1003_reg_169 <= icmp_ln1003_fu_137_p2;
                icmp_ln1003_reg_169_pp0_iter1_reg <= icmp_ln1003_reg_169;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem1_ARREADY, din_empty_n, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln882_fu_107_p2, icmp_ln1003_fu_137_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (din_empty_n = ap_const_logic_0))) and (icmp_ln882_fu_107_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state75;
                elsif ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (din_empty_n = ap_const_logic_0))) and (icmp_ln882_fu_107_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1003_fu_137_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1003_fu_137_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)))) then
                    ap_NS_fsm <= ap_ST_fsm_state75;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                end if;
    ...
    add_ln695_fu_142_p2 <= std_logic_vector(unsigned(empty_378_reg_96) + unsigned(ap_const_lv20_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_gmem1_RVALID, ldata1_full_n, ap_enable_reg_pp0_iter1, icmp_ln1003_reg_169, ap_enable_reg_pp0_iter2, icmp_ln1003_reg_169_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_01001 <= (((icmp_ln1003_reg_169_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ldata1_full_n = ap_const_logic_0)) or ((icmp_ln1003_reg_169 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_gmem1_RVALID, ldata1_full_n, ap_enable_reg_pp0_iter1, icmp_ln1003_reg_169, ap_enable_reg_pp0_iter2, icmp_ln1003_reg_169_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln1003_reg_169_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ldata1_full_n = ap_const_logic_0)) or ((icmp_ln1003_reg_169 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_gmem1_RVALID, ldata1_full_n, ap_enable_reg_pp0_iter1, icmp_ln1003_reg_169, ap_enable_reg_pp0_iter2, icmp_ln1003_reg_169_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln1003_reg_169_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ldata1_full_n = ap_const_logic_0)) or ((icmp_ln1003_reg_169 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;
    ...
    ap_block_state73_pp0_stage0_iter1_assign_proc : process(m_axi_gmem1_RVALID, icmp_ln1003_reg_169)
    begin
                ap_block_state73_pp0_stage0_iter1 <= ((icmp_ln1003_reg_169 = ap_const_lv1_0) and (m_axi_gmem1_RVALID = ap_const_logic_0));
    end process;


    ap_block_state74_pp0_stage0_iter2_assign_proc : process(ldata1_full_n, icmp_ln1003_reg_169_pp0_iter1_reg)
    begin
                ap_block_state74_pp0_stage0_iter2 <= ((icmp_ln1003_reg_169_pp0_iter1_reg = ap_const_lv1_0) and (ldata1_full_n = ap_const_logic_0));
    end process;


    ap_condition_pp0_exit_iter0_state72_assign_proc : process(icmp_ln1003_fu_137_p2)
    begin
        if ((icmp_ln1003_fu_137_p2 = ap_const_lv1_1)) then 
    ...
    gmem1_blk_n_R_assign_proc : process(m_axi_gmem1_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln1003_reg_169)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1003_reg_169 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    icmp_ln1003_fu_137_p2 <= "1" when (empty_378_reg_96 = addrbound_V_read) else "0";
    icmp_ln882_fu_107_p2 <= "1" when (addrbound_V_read = ap_const_lv20_0) else "0";

    ldata1_blk_n_assign_proc : process(ldata1_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter2, icmp_ln1003_reg_169_pp0_iter1_reg)
    begin
        if (((icmp_ln1003_reg_169_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    ldata1_din <= gmem1_addr_read_reg_178;

    ldata1_write_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln1003_reg_169_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1003_reg_169_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    m_axi_gmem1_ARADDR <= gmem1_addr_reg_158;
    ...
    m_axi_gmem1_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln1003_reg_169, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1003_reg_169 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    m_axi_gmem1_WVALID <= ap_const_logic_0;
        sext_ln1003_fu_123_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_113_p4),64));

    trunc_ln_fu_113_p4 <= din_dout(63 downto 2);
end behav;
