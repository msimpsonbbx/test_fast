...
entity pyr_dense_optical_flow_accel_AxiStream2Axi is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pyr_dense_optical_flow_accel_AxiStream2Axi is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1305_reg_171 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem4_blk_n_AW : STD_LOGIC;
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal gmem4_blk_n_W : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal icmp_ln1305_reg_171_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_358_reg_103 : STD_LOGIC_VECTOR (21 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal icmp_ln882_fu_114_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem4_addr_reg_165 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln1305_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state3_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state4_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state5_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_state5_io : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal add_ln695_fu_149_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal ldata1_read_reg_180 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state3 : STD_LOGIC;
    signal sext_ln1305_fu_130_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state73 : BOOLEAN;
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal trunc_ln_fu_120_p4 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((icmp_ln882_reg_161 = ap_const_lv1_0) and (m_axi_gmem4_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_condition_pp0_exit_iter0_state3) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem4_AWREADY = ap_const_logic_1))) then 
    ...
    empty_358_reg_103_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1305_fu_144_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                empty_358_reg_103 <= add_ln695_fu_149_p2;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem4_AWREADY = ap_const_logic_1))) then 
                empty_358_reg_103 <= ap_const_lv22_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (dout_empty_n = ap_const_logic_0))) and (icmp_ln882_fu_114_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                gmem4_addr_reg_165 <= sext_ln1305_fu_130_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln1305_reg_171 <= icmp_ln1305_fu_144_p2;
                icmp_ln1305_reg_171_pp0_iter1_reg <= icmp_ln1305_reg_171;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (dout_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                icmp_ln882_reg_161 <= icmp_ln882_fu_114_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1305_reg_171 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ldata1_read_reg_180 <= ldata1_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem4_AWREADY, m_axi_gmem4_BVALID, dout_empty_n, ap_enable_reg_pp0_iter1, ap_CS_fsm_state2, ap_enable_reg_pp0_iter2, ap_CS_fsm_state73, icmp_ln882_reg_161, icmp_ln882_fu_114_p2, icmp_ln1305_fu_144_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (dout_empty_n = ap_const_logic_0))) and (icmp_ln882_fu_114_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state73;
                elsif ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (dout_empty_n = ap_const_logic_0))) and (icmp_ln882_fu_114_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem4_AWREADY = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1305_fu_144_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1305_fu_144_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)))) then
            ...
            when ap_ST_fsm_state73 => 
                if ((not(((icmp_ln882_reg_161 = ap_const_lv1_0) and (m_axi_gmem4_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state73;
                end if;
    ...
    add_ln695_fu_149_p2 <= std_logic_vector(unsigned(empty_358_reg_103) + unsigned(ap_const_lv22_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ldata1_empty_n, ap_enable_reg_pp0_iter1, icmp_ln1305_reg_171)
    begin
                ap_block_pp0_stage0_01001 <= ((ldata1_empty_n = ap_const_logic_0) and (icmp_ln1305_reg_171 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ldata1_empty_n, ap_enable_reg_pp0_iter1, icmp_ln1305_reg_171, ap_enable_reg_pp0_iter2, ap_block_state5_io)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_const_boolean_1 = ap_block_state5_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ldata1_empty_n = ap_const_logic_0) and (icmp_ln1305_reg_171 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ldata1_empty_n, ap_enable_reg_pp0_iter1, icmp_ln1305_reg_171, ap_enable_reg_pp0_iter2, ap_block_state5_io)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_const_boolean_1 = ap_block_state5_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ldata1_empty_n = ap_const_logic_0) and (icmp_ln1305_reg_171 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;
    ...
    ap_block_state4_pp0_stage0_iter1_assign_proc : process(ldata1_empty_n, icmp_ln1305_reg_171)
    begin
                ap_block_state4_pp0_stage0_iter1 <= ((ldata1_empty_n = ap_const_logic_0) and (icmp_ln1305_reg_171 = ap_const_lv1_0));
    end process;


    ap_block_state5_io_assign_proc : process(m_axi_gmem4_WREADY, icmp_ln1305_reg_171_pp0_iter1_reg)
    begin
                ap_block_state5_io <= ((icmp_ln1305_reg_171_pp0_iter1_reg = ap_const_lv1_0) and (m_axi_gmem4_WREADY = ap_const_logic_0));
    end process;

        ap_block_state5_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state73_assign_proc : process(m_axi_gmem4_BVALID, icmp_ln882_reg_161)
    begin
                ap_block_state73 <= ((icmp_ln882_reg_161 = ap_const_lv1_0) and (m_axi_gmem4_BVALID = ap_const_logic_0));
    end process;


    ap_condition_pp0_exit_iter0_state3_assign_proc : process(icmp_ln1305_fu_144_p2)
    begin
        if ((icmp_ln1305_fu_144_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, m_axi_gmem4_BVALID, ap_CS_fsm_state73, icmp_ln882_reg_161)
    begin
        if ((not(((icmp_ln882_reg_161 = ap_const_lv1_0) and (m_axi_gmem4_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    ap_ready_assign_proc : process(m_axi_gmem4_BVALID, ap_CS_fsm_state73, icmp_ln882_reg_161)
    begin
        if ((not(((icmp_ln882_reg_161 = ap_const_lv1_0) and (m_axi_gmem4_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    gmem4_blk_n_B_assign_proc : process(m_axi_gmem4_BVALID, ap_CS_fsm_state73, icmp_ln882_reg_161)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln882_reg_161 = ap_const_lv1_0))) then 
    ...
    gmem4_blk_n_W_assign_proc : process(m_axi_gmem4_WREADY, ap_block_pp0_stage0, ap_enable_reg_pp0_iter2, icmp_ln1305_reg_171_pp0_iter1_reg)
    begin
        if (((icmp_ln1305_reg_171_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    icmp_ln1305_fu_144_p2 <= "1" when (empty_358_reg_103 = addrbound_V_read) else "0";
    icmp_ln882_fu_114_p2 <= "1" when (addrbound_V_read = ap_const_lv22_0) else "0";

    ldata1_blk_n_assign_proc : process(ldata1_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln1305_reg_171)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1305_reg_171 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    ldata1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln1305_reg_171, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1305_reg_171 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    m_axi_gmem4_AWADDR <= gmem4_addr_reg_165;
    m_axi_gmem4_AWBURST <= ap_const_lv2_0;
    m_axi_gmem4_AWCACHE <= ap_const_lv4_0;
    m_axi_gmem4_AWID <= ap_const_lv1_0;
    m_axi_gmem4_AWLEN <= std_logic_vector(IEEE.numeric_std.resize(unsigned(addrbound_V_read),32));
    ...
    m_axi_gmem4_AWVALID_assign_proc : process(m_axi_gmem4_AWREADY, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem4_AWREADY = ap_const_logic_1))) then 
    ...
    m_axi_gmem4_BREADY_assign_proc : process(m_axi_gmem4_BVALID, ap_CS_fsm_state73, icmp_ln882_reg_161)
    begin
        if ((not(((icmp_ln882_reg_161 = ap_const_lv1_0) and (m_axi_gmem4_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln882_reg_161 = ap_const_lv1_0))) then 
    ...
    m_axi_gmem4_WDATA <= ldata1_read_reg_180;
    ...
    m_axi_gmem4_WVALID_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln1305_reg_171_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln1305_reg_171_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
        ...
        sext_ln1305_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_120_p4),64));

    trunc_ln_fu_120_p4 <= dout_dout(63 downto 2);
end behav;
