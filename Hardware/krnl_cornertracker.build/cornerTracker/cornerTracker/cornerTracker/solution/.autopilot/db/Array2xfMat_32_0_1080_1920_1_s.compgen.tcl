...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dstMat_1_dout { I 11 vector } dstMat_1_empty_n { I 1 bit } dstMat_1_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dstMat_2_dout { I 11 vector } dstMat_2_empty_n { I 1 bit } dstMat_2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dstMat_1_out_din { O 11 vector } dstMat_1_out_full_n { I 1 bit } dstMat_1_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dstMat_2_out_din { O 11 vector } dstMat_2_out_full_n { I 1 bit } dstMat_2_out_write { O 1 bit } } \
} "
}
