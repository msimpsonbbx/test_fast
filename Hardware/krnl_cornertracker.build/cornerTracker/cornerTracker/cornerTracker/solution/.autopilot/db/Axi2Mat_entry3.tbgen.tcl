...
set C_modelName {Axi2Mat.entry3}
...
set portList { 
	...
	{ din sc_in sc_lv 64 signal 0 } 
	{ rows sc_in sc_lv 11 signal 1 } 
	{ cols sc_in sc_lv 11 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "din_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	din { ap_none {  { din in_data 0 64 } } }
	rows { ap_none {  { rows in_data 0 11 } } }
