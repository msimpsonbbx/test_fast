...
eval "cg_default_interface_gen_dc { \
    id 328 \
    name out_harris_mat_420 \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_out_harris_mat_420 \
    op interface \
    ports { out_harris_mat_420_dout { I 8 vector } out_harris_mat_420_empty_n { I 1 bit } out_harris_mat_420_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p_src_1 \
    op interface \
    ports { p_src_1_dout { I 11 vector } p_src_1_empty_n { I 1 bit } p_src_1_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p_src_2 \
    op interface \
    ports { p_src_2_dout { I 11 vector } p_src_2_empty_n { I 1 bit } p_src_2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_list \
    op interface \
    ports { list_dout { I 64 vector } list_empty_n { I 1 bit } list_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_ncorners \
    op interface \
    ports { ncorners { O 32 vector } ncorners_ap_vld { O 1 bit } } \
} "
}
