...
set C_modelArgList {
	...
	{ cols_bound_per_npc int 11 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ldata1", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "cols_bound_per_npc", "interface" : "fifo", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rows_dout sc_in sc_lv 11 signal 2 } 
	{ rows_empty_n sc_in sc_logic 1 signal 2 } 
	{ rows_read sc_out sc_logic 1 signal 2 } 
	{ cols_bound_per_npc_dout sc_in sc_lv 11 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "cols_bound_per_npc_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "cols_bound_per_npc", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_11ns_11ns_22_4_1_U38", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	cols_bound_per_npc { ap_fifo {  { cols_bound_per_npc_dout fifo_data 0 11 }  { cols_bound_per_npc_empty_n fifo_status 0 1 }  { cols_bound_per_npc_read fifo_update 1 1 } } }
