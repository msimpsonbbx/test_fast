set moduleName cornersImgToList_10000u_0u_1080u_1920u_1u_s
set isTopModule 0
...
set C_modelName {cornersImgToList<10000u, 0u, 1080u, 1920u, 1u>}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_harris_mat_420 int 8 regular {fifo 0 volatile }  }
	{ gmem2 int 32 regular {axi_master 1}  }
	{ p_src_1 int 11 regular {fifo 0}  }
	{ p_src_2 int 11 regular {fifo 0}  }
	{ list int 64 regular {fifo 0}  }
	{ ncorners int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_harris_mat_420", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_src_1", "interface" : "fifo", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "p_src_2", "interface" : "fifo", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "list", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_harris_mat_420_dout sc_in sc_lv 8 signal 0 } 
	{ out_harris_mat_420_empty_n sc_in sc_logic 1 signal 0 } 
	{ out_harris_mat_420_read sc_out sc_logic 1 signal 0 } 
	...
	{ p_src_1_dout sc_in sc_lv 11 signal 2 } 
	{ p_src_1_empty_n sc_in sc_logic 1 signal 2 } 
	{ p_src_1_read sc_out sc_logic 1 signal 2 } 
	{ p_src_2_dout sc_in sc_lv 11 signal 3 } 
	{ p_src_2_empty_n sc_in sc_logic 1 signal 3 } 
	{ p_src_2_read sc_out sc_logic 1 signal 3 } 
	{ list_dout sc_in sc_lv 64 signal 4 } 
	{ list_empty_n sc_in sc_logic 1 signal 4 } 
	{ list_read sc_out sc_logic 1 signal 4 } 
	{ ncorners sc_out sc_lv 32 signal 5 } 
	{ ncorners_ap_vld sc_out sc_logic 1 outvld 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_harris_mat_420_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "out_harris_mat_420", "role": "dout" }} , 
 	{ "name": "out_harris_mat_420_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_harris_mat_420", "role": "empty_n" }} , 
 	{ "name": "out_harris_mat_420_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_harris_mat_420", "role": "read" }} , 
 	...
 	{ "name": "p_src_1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "p_src_1", "role": "dout" }} , 
 	...
 	{ "name": "p_src_2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "p_src_2", "role": "dout" }} , 
 	...
 	{ "name": "list_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "list", "role": "dout" }} , 
 	{ "name": "list_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "list", "role": "empty_n" }} , 
 	{ "name": "list_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "list", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "out_harris_mat_420", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2",
				"BlockSignal" : [
			...
			{"Name" : "p_src_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4",
				"BlockSignal" : [
					{"Name" : "p_src_1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_src_2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4",
				"BlockSignal" : [
					{"Name" : "p_src_2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "list", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "4",
				"BlockSignal" : [
					{"Name" : "list_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "ncorners", "Type" : "Vld", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_11ns_11ns_22_4_1_U327", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	out_harris_mat_420 { ap_fifo {  { out_harris_mat_420_dout fifo_data 0 8 }  { out_harris_mat_420_empty_n fifo_status 0 1 }  { out_harris_mat_420_read fifo_update 1 1 } } }
	...
	p_src_1 { ap_fifo {  { p_src_1_dout fifo_data 0 11 }  { p_src_1_empty_n fifo_status 0 1 }  { p_src_1_read fifo_update 1 1 } } }
	p_src_2 { ap_fifo {  { p_src_2_dout fifo_data 0 11 }  { p_src_2_empty_n fifo_status 0 1 }  { p_src_2_read fifo_update 1 1 } } }
	list { ap_fifo {  { list_dout fifo_data 0 64 }  { list_empty_n fifo_status 0 1 }  { list_read fifo_update 1 1 } } }
