...
entity cornerTracker_Axi2AxiStream is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cornerTracker_Axi2AxiStream is 
...
attribute shreg_extract : string;
    ...
    signal empty_167_reg_96 : STD_LOGIC_VECTOR (19 downto 0);
...
begin
    ...
    empty_167_reg_96_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1003_fu_137_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                empty_167_reg_96 <= add_ln695_fu_142_p2;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state71)) then 
                empty_167_reg_96 <= ap_const_lv20_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln695_fu_142_p2 <= std_logic_vector(unsigned(empty_167_reg_96) + unsigned(ap_const_lv20_1));
    ...
    icmp_ln1003_fu_137_p2 <= "1" when (empty_167_reg_96 = addrbound_V_read) else "0";
