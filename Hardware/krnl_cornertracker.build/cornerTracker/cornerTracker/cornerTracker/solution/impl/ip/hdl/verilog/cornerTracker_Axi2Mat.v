...
wire   [10:0] Axi2Mat_entry3_U0_rows_out_din;
wire    Axi2Mat_entry3_U0_rows_out_write;
wire   [10:0] Axi2Mat_entry3_U0_cols_out_din;
wire    Axi2Mat_entry3_U0_cols_out_write;
wire    Axi2Mat_entry44_U0_ap_start;
wire    Axi2Mat_entry44_U0_ap_done;
wire    Axi2Mat_entry44_U0_ap_continue;
wire    Axi2Mat_entry44_U0_ap_idle;
wire    Axi2Mat_entry44_U0_ap_ready;
wire    Axi2Mat_entry44_U0_start_out;
wire    Axi2Mat_entry44_U0_start_write;
wire    Axi2Mat_entry44_U0_din_read;
wire    Axi2Mat_entry44_U0_rows_read;
wire    Axi2Mat_entry44_U0_cols_read;
wire   [63:0] Axi2Mat_entry44_U0_din_out_din;
wire    Axi2Mat_entry44_U0_din_out_write;
wire   [10:0] Axi2Mat_entry44_U0_rows_out_din;
wire    Axi2Mat_entry44_U0_rows_out_write;
wire   [10:0] Axi2Mat_entry44_U0_cols_out_din;
wire    Axi2Mat_entry44_U0_cols_out_write;
...
wire   [19:0] Axi2Mat_Block_split15_proc_U0_ap_return;
...
wire   [7:0] AxiStream2MatStream_U0_in_harris_mat_419_din;
wire    AxiStream2MatStream_U0_in_harris_mat_419_write;
...
wire    din_c1_empty_n;
wire    rows_c2_full_n;
wire   [10:0] rows_c2_dout;
wire    rows_c2_empty_n;
wire    cols_c3_full_n;
wire   [10:0] cols_c3_dout;
...
wire   [10:0] rows_c13_dout;
wire    rows_c13_empty_n;
wire    cols_c14_full_n;
wire   [10:0] cols_c14_dout;
...
wire   [0:0] start_for_Axi2Mat_entry44_U0_din;
wire    start_for_Axi2Mat_entry44_U0_full_n;
wire   [0:0] start_for_Axi2Mat_entry44_U0_dout;
wire    start_for_Axi2Mat_entry44_U0_empty_n;
...
cornerTracker_Axi2Mat_entry3 Axi2Mat_entry3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cornerTracker_Axi2Mat_entry44 Axi2Mat_entry44_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cornerTracker_last_blk_pxl_width last_blk_pxl_width_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cornerTracker_addrbound addrbound_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cornerTracker_Axi2Mat_Block_split15_proc Axi2Mat_Block_split15_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cornerTracker_Axi2AxiStream Axi2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cornerTracker_AxiStream2MatStream AxiStream2MatStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cornerTracker_fifo_w64_d2_S din_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w11_d2_S rows_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w11_d2_S cols_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w64_d4_S din_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w11_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w11_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w4_d6_S last_blk_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w20_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w11_d4_S rows_c13_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w11_d4_S cols_c14_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w20_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_fifo_w32_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_start_for_Axi2Mat_entry44_U0 start_for_Axi2Mat_entry44_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_start_for_addrbound_U0 start_for_addrbound_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cornerTracker_start_for_AxiStream2MatStream_U0 start_for_AxiStream2MatStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Axi2Mat_entry44_U0_ap_continue = 1'b1;

assign Axi2Mat_entry44_U0_ap_start = start_for_Axi2Mat_entry44_U0_empty_n;
...
assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound_U0_ap_idle & AxiStream2MatStream_U0_ap_idle & Axi2Mat_entry44_U0_ap_idle & Axi2Mat_entry3_U0_ap_idle & Axi2Mat_Block_split15_proc_U0_ap_idle & Axi2AxiStream_U0_ap_idle);
...
assign in_harris_mat_419_din = AxiStream2MatStream_U0_in_harris_mat_419_din;

assign in_harris_mat_419_write = AxiStream2MatStream_U0_in_harris_mat_419_write;
