...
entity cornerTracker_xFDuplicate_2_1080_1920_3_1_5_1920_24 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cornerTracker_xFDuplicate_2_1080_1920_3_1_5_1920_24 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln43_reg_195 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_64_reg_143 : STD_LOGIC_VECTOR (10 downto 0);
    signal img_height_read_reg_176 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal img_width_read_reg_181 : STD_LOGIC_VECTOR (10 downto 0);
    signal icmp_ln37_fu_154_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal add_ln695_fu_159_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln695_reg_190 : STD_LOGIC_VECTOR (10 downto 0);
    signal icmp_ln43_fu_165_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state3_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state4_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal add_ln695_8_fu_170_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state3 : STD_LOGIC;
    signal empty_reg_132 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln37_fu_154_p2 = ap_const_lv1_1))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state3))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln37_fu_154_p2 = ap_const_lv1_0))) then 
    ...
    empty_64_reg_143_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln43_fu_165_p2 = ap_const_lv1_0))) then 
                empty_64_reg_143 <= add_ln695_8_fu_170_p2;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln37_fu_154_p2 = ap_const_lv1_0))) then 
                empty_64_reg_143 <= ap_const_lv11_0;
            end if; 
        end if;
    end process;

    empty_reg_132_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                empty_reg_132 <= add_ln695_reg_190;
            elsif ((not(((img_width_out2_full_n = ap_const_logic_0) or (img_width_out_full_n = ap_const_logic_0) or (img_height_out1_full_n = ap_const_logic_0) or (img_height_out_full_n = ap_const_logic_0) or (img_width_empty_n = ap_const_logic_0) or (img_height_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (real_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                empty_reg_132 <= ap_const_lv11_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                add_ln695_reg_190 <= add_ln695_fu_159_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln43_reg_195 <= icmp_ln43_fu_165_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((img_width_out2_full_n = ap_const_logic_0) or (img_width_out_full_n = ap_const_logic_0) or (img_height_out1_full_n = ap_const_logic_0) or (img_height_out_full_n = ap_const_logic_0) or (img_width_empty_n = ap_const_logic_0) or (img_height_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (real_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                img_height_read_reg_176 <= img_height_dout;
                img_width_read_reg_181 <= img_width_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, img_height_empty_n, img_width_empty_n, img_height_out_full_n, img_height_out1_full_n, img_width_out_full_n, img_width_out2_full_n, icmp_ln37_fu_154_p2, ap_CS_fsm_state2, icmp_ln43_fu_165_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln37_fu_154_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                end if;
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln43_fu_165_p2 = ap_const_lv1_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln43_fu_165_p2 = ap_const_lv1_1))) then
    ...
    add_ln695_8_fu_170_p2 <= std_logic_vector(unsigned(empty_64_reg_143) + unsigned(ap_const_lv11_1));
    add_ln695_fu_159_p2 <= std_logic_vector(unsigned(empty_reg_132) + unsigned(ap_const_lv11_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(gradx_mat_49_empty_n, gradx1_mat_411_full_n, gradx2_mat_413_full_n, ap_enable_reg_pp0_iter1, icmp_ln43_reg_195)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx2_mat_413_full_n = ap_const_logic_0)) or ((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx1_mat_411_full_n = ap_const_logic_0)) or ((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx_mat_49_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(gradx_mat_49_empty_n, gradx1_mat_411_full_n, gradx2_mat_413_full_n, ap_enable_reg_pp0_iter1, icmp_ln43_reg_195)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx2_mat_413_full_n = ap_const_logic_0)) or ((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx1_mat_411_full_n = ap_const_logic_0)) or ((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx_mat_49_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(gradx_mat_49_empty_n, gradx1_mat_411_full_n, gradx2_mat_413_full_n, ap_enable_reg_pp0_iter1, icmp_ln43_reg_195)
    begin
    ...
    ap_block_state4_pp0_stage0_iter1_assign_proc : process(gradx_mat_49_empty_n, gradx1_mat_411_full_n, gradx2_mat_413_full_n, icmp_ln43_reg_195)
    begin
                ap_block_state4_pp0_stage0_iter1 <= (((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx2_mat_413_full_n = ap_const_logic_0)) or ((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx1_mat_411_full_n = ap_const_logic_0)) or ((icmp_ln43_reg_195 = ap_const_lv1_0) and (gradx_mat_49_empty_n = ap_const_logic_0)));
    end process;


    ap_condition_pp0_exit_iter0_state3_assign_proc : process(icmp_ln43_fu_165_p2)
    begin
        if ((icmp_ln43_fu_165_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, icmp_ln37_fu_154_p2, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln37_fu_154_p2 = ap_const_lv1_1))) then 
    ...
    gradx1_mat_411_blk_n_assign_proc : process(gradx1_mat_411_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln43_reg_195)
    begin
        if (((icmp_ln43_reg_195 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    gradx1_mat_411_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln43_reg_195, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln43_reg_195 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    gradx2_mat_413_blk_n_assign_proc : process(gradx2_mat_413_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln43_reg_195)
    begin
        if (((icmp_ln43_reg_195 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    gradx2_mat_413_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln43_reg_195, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln43_reg_195 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    gradx_mat_49_blk_n_assign_proc : process(gradx_mat_49_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln43_reg_195)
    begin
        if (((icmp_ln43_reg_195 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    gradx_mat_49_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln43_reg_195, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln43_reg_195 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln37_fu_154_p2 <= "1" when (empty_reg_132 = img_height_read_reg_176) else "0";
    icmp_ln43_fu_165_p2 <= "1" when (empty_64_reg_143 = img_width_read_reg_181) else "0";
    ...
    internal_ap_ready_assign_proc : process(icmp_ln37_fu_154_p2, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln37_fu_154_p2 = ap_const_lv1_1))) then 
