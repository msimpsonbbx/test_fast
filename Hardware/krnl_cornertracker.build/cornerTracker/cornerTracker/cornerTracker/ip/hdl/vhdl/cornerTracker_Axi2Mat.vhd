...
entity cornerTracker_Axi2Mat is
port (
...
architecture behav of cornerTracker_Axi2Mat is 
...
attribute shreg_extract : string;
    ...
    signal Axi2Mat_entry3_U0_rows_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Axi2Mat_entry3_U0_rows_out_write : STD_LOGIC;
    signal Axi2Mat_entry3_U0_cols_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Axi2Mat_entry3_U0_cols_out_write : STD_LOGIC;
    signal Axi2Mat_entry44_U0_ap_start : STD_LOGIC;
    signal Axi2Mat_entry44_U0_ap_done : STD_LOGIC;
    signal Axi2Mat_entry44_U0_ap_continue : STD_LOGIC;
    signal Axi2Mat_entry44_U0_ap_idle : STD_LOGIC;
    signal Axi2Mat_entry44_U0_ap_ready : STD_LOGIC;
    signal Axi2Mat_entry44_U0_start_out : STD_LOGIC;
    signal Axi2Mat_entry44_U0_start_write : STD_LOGIC;
    signal Axi2Mat_entry44_U0_din_read : STD_LOGIC;
    signal Axi2Mat_entry44_U0_rows_read : STD_LOGIC;
    signal Axi2Mat_entry44_U0_cols_read : STD_LOGIC;
    signal Axi2Mat_entry44_U0_din_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal Axi2Mat_entry44_U0_din_out_write : STD_LOGIC;
    signal Axi2Mat_entry44_U0_rows_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Axi2Mat_entry44_U0_rows_out_write : STD_LOGIC;
    signal Axi2Mat_entry44_U0_cols_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Axi2Mat_entry44_U0_cols_out_write : STD_LOGIC;
    ...
    signal addrbound_U0_rows_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal addrbound_U0_rows_out_write : STD_LOGIC;
    signal addrbound_U0_cols_out_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal Axi2Mat_Block_split15_proc_U0_ap_return : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal AxiStream2MatStream_U0_in_harris_mat_419_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AxiStream2MatStream_U0_in_harris_mat_419_write : STD_LOGIC;
    ...
    signal rows_c13_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal rows_c13_empty_n : STD_LOGIC;
    signal cols_c14_full_n : STD_LOGIC;
    signal cols_c14_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal start_for_Axi2Mat_entry44_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Axi2Mat_entry44_U0_full_n : STD_LOGIC;
    signal start_for_Axi2Mat_entry44_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Axi2Mat_entry44_U0_empty_n : STD_LOGIC;
    ...
    component cornerTracker_Axi2Mat_entry3 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cornerTracker_Axi2Mat_entry44 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cornerTracker_last_blk_pxl_width IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cornerTracker_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cornerTracker_Axi2Mat_Block_split15_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cornerTracker_Axi2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cornerTracker_AxiStream2MatStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cornerTracker_fifo_w64_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component cornerTracker_fifo_w11_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cornerTracker_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cornerTracker_fifo_w4_d6_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cornerTracker_fifo_w20_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cornerTracker_fifo_w11_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cornerTracker_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cornerTracker_start_for_Axi2Mat_entry44_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cornerTracker_start_for_addrbound_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cornerTracker_start_for_AxiStream2MatStream_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    Axi2Mat_entry3_U0 : component cornerTracker_Axi2Mat_entry3
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => Axi2Mat_entry3_U0_ap_start,
        start_full_n => start_for_Axi2Mat_entry44_U0_full_n,
    ...
    Axi2Mat_entry44_U0 : component cornerTracker_Axi2Mat_entry44
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => Axi2Mat_entry44_U0_ap_start,
        start_full_n => start_for_addrbound_U0_full_n,
        ap_done => Axi2Mat_entry44_U0_ap_done,
        ap_continue => Axi2Mat_entry44_U0_ap_continue,
        ap_idle => Axi2Mat_entry44_U0_ap_idle,
        ap_ready => Axi2Mat_entry44_U0_ap_ready,
        start_out => Axi2Mat_entry44_U0_start_out,
        start_write => Axi2Mat_entry44_U0_start_write,
        din_dout => din_c1_dout,
        din_empty_n => din_c1_empty_n,
        din_read => Axi2Mat_entry44_U0_din_read,
        rows_dout => rows_c2_dout,
        rows_empty_n => rows_c2_empty_n,
        rows_read => Axi2Mat_entry44_U0_rows_read,
        cols_dout => cols_c3_dout,
        cols_empty_n => cols_c3_empty_n,
        cols_read => Axi2Mat_entry44_U0_cols_read,
        din_out_din => Axi2Mat_entry44_U0_din_out_din,
        din_out_full_n => din_c_full_n,
        din_out_write => Axi2Mat_entry44_U0_din_out_write,
        rows_out_din => Axi2Mat_entry44_U0_rows_out_din,
        rows_out_full_n => rows_c_full_n,
        rows_out_write => Axi2Mat_entry44_U0_rows_out_write,
        cols_out_din => Axi2Mat_entry44_U0_cols_out_din,
        cols_out_full_n => cols_c_full_n,
        cols_out_write => Axi2Mat_entry44_U0_cols_out_write);

    last_blk_pxl_width_U0 : component cornerTracker_last_blk_pxl_width
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    addrbound_U0 : component cornerTracker_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Axi2Mat_Block_split15_proc_U0 : component cornerTracker_Axi2Mat_Block_split15_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Axi2AxiStream_U0 : component cornerTracker_Axi2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2MatStream_U0 : component cornerTracker_AxiStream2MatStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        in_harris_mat_419_din => AxiStream2MatStream_U0_in_harris_mat_419_din,
        in_harris_mat_419_full_n => in_harris_mat_419_full_n,
        in_harris_mat_419_write => AxiStream2MatStream_U0_in_harris_mat_419_write,
    ...
    din_c1_U : component cornerTracker_fifo_w64_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        ...
        if_read => Axi2Mat_entry44_U0_din_read);

    rows_c2_U : component cornerTracker_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => Axi2Mat_entry44_U0_rows_read);

    cols_c3_U : component cornerTracker_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => Axi2Mat_entry44_U0_cols_read);

    din_c_U : component cornerTracker_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Axi2Mat_entry44_U0_din_out_din,
        if_full_n => din_c_full_n,
        if_write => Axi2Mat_entry44_U0_din_out_write,
        if_dout => din_c_dout,
        if_empty_n => din_c_empty_n,
        if_read => Axi2AxiStream_U0_din_read);

    rows_c_U : component cornerTracker_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Axi2Mat_entry44_U0_rows_out_din,
        if_full_n => rows_c_full_n,
        if_write => Axi2Mat_entry44_U0_rows_out_write,
        if_dout => rows_c_dout,
        if_empty_n => rows_c_empty_n,
        if_read => addrbound_U0_rows_read);

    cols_c_U : component cornerTracker_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Axi2Mat_entry44_U0_cols_out_din,
        if_full_n => cols_c_full_n,
        if_write => Axi2Mat_entry44_U0_cols_out_write,
        if_dout => cols_c_dout,
        if_empty_n => cols_c_empty_n,
        if_read => addrbound_U0_cols_read);

    last_blk_width_c_U : component cornerTracker_fifo_w4_d6_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    p_channel_U : component cornerTracker_fifo_w20_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    rows_c13_U : component cornerTracker_fifo_w11_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_c14_U : component cornerTracker_fifo_w11_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_V_U : component cornerTracker_fifo_w20_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component cornerTracker_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Axi2Mat_entry44_U0_U : component cornerTracker_start_for_Axi2Mat_entry44_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_Axi2Mat_entry44_U0_din,
        if_full_n => start_for_Axi2Mat_entry44_U0_full_n,
        if_write => Axi2Mat_entry3_U0_start_write,
        if_dout => start_for_Axi2Mat_entry44_U0_dout,
        if_empty_n => start_for_Axi2Mat_entry44_U0_empty_n,
        if_read => Axi2Mat_entry44_U0_ap_ready);

    start_for_addrbound_U0_U : component cornerTracker_start_for_addrbound_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_write => Axi2Mat_entry44_U0_start_write,
        if_dout => start_for_addrbound_U0_dout,
        if_empty_n => start_for_addrbound_U0_empty_n,
        if_read => addrbound_U0_ap_ready);

    start_for_AxiStream2MatStream_U0_U : component cornerTracker_start_for_AxiStream2MatStream_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    Axi2Mat_entry44_U0_ap_continue <= ap_const_logic_1;
    Axi2Mat_entry44_U0_ap_start <= start_for_Axi2Mat_entry44_U0_empty_n;
    ...
    ap_done <= AxiStream2MatStream_U0_ap_done;
    ap_idle <= (last_blk_pxl_width_U0_ap_idle and (axibound_V_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and addrbound_U0_ap_idle and AxiStream2MatStream_U0_ap_idle and Axi2Mat_entry44_U0_ap_idle and Axi2Mat_entry3_U0_ap_idle and Axi2Mat_Block_split15_proc_U0_ap_idle and Axi2AxiStream_U0_ap_idle);
    ...
    start_for_Axi2Mat_entry44_U0_din <= (0=>ap_const_logic_1, others=>'-');
