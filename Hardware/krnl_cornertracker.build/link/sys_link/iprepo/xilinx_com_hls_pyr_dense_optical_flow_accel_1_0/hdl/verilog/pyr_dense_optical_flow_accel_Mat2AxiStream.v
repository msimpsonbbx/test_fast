...
module pyr_dense_optical_flow_accel_Mat2AxiStream (
...
wire    last_blk_pxl_width58_U0_ap_start;
wire    last_blk_pxl_width58_U0_ap_done;
wire    last_blk_pxl_width58_U0_ap_continue;
wire    last_blk_pxl_width58_U0_ap_idle;
wire    last_blk_pxl_width58_U0_ap_ready;
wire   [5:0] last_blk_pxl_width58_U0_return_r;
wire    last_blk_pxl_width58_U0_return_r_ap_vld;
wire    last_blk_pxl_width58_U0_rows_read;
wire    last_blk_pxl_width58_U0_cols_read;
wire   [31:0] last_blk_pxl_width58_U0_rows_out_din;
wire    last_blk_pxl_width58_U0_rows_out_write;
wire   [31:0] last_blk_pxl_width58_U0_cols_out_din;
wire    last_blk_pxl_width58_U0_cols_out_write;
...
wire    MatStream2AxiStream_U0_streamFlowout_mat_437_read;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_last_blk_pxl_width58_U0_ap_ready;
wire    ap_sync_last_blk_pxl_width58_U0_ap_ready;
reg   [1:0] last_blk_pxl_width58_U0_ap_ready_count;
...
wire    last_blk_pxl_width58_U0_start_full_n;
wire    last_blk_pxl_width58_U0_start_write;
wire    MatStream2AxiStream_U0_start_full_n;
wire    MatStream2AxiStream_U0_start_write;

// power-on initialization
initial begin
#0 ap_sync_reg_last_blk_pxl_width58_U0_ap_ready = 1'b0;
#0 last_blk_pxl_width58_U0_ap_ready_count = 2'd0;
#0 ap_sync_reg_MatStream2AxiStream_U0_ap_ready = 1'b0;
#0 MatStream2AxiStream_U0_ap_ready_count = 2'd0;
end

pyr_dense_optical_flow_accel_last_blk_pxl_width58 last_blk_pxl_width58_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_MatStream2AxiStream MatStream2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_fifo_w6_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d2_S_x1 rows_c_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d2_S_x1 cols_c_i_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_last_blk_pxl_width58_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_last_blk_pxl_width58_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((ap_sync_ready == 1'b1) & (last_blk_pxl_width58_U0_ap_ready == 1'b0))) begin
        last_blk_pxl_width58_U0_ap_ready_count <= (last_blk_pxl_width58_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (last_blk_pxl_width58_U0_ap_ready == 1'b1))) begin
        last_blk_pxl_width58_U0_ap_ready_count <= (last_blk_pxl_width58_U0_ap_ready_count + 2'd1);
    end
end
...
assign ap_channel_done_p_channel = last_blk_pxl_width58_U0_ap_done;

assign ap_done = MatStream2AxiStream_U0_ap_done;

assign ap_idle = (last_blk_pxl_width58_U0_ap_idle & (p_channel_empty_n ^ 1'b1) & MatStream2AxiStream_U0_ap_idle);
...
assign ap_sync_last_blk_pxl_width58_U0_ap_ready = (last_blk_pxl_width58_U0_ap_ready | ap_sync_reg_last_blk_pxl_width58_U0_ap_ready);

assign ap_sync_ready = (ap_sync_last_blk_pxl_width58_U0_ap_ready & ap_sync_MatStream2AxiStream_U0_ap_ready);

assign cols_read = last_blk_pxl_width58_U0_cols_read;

assign last_blk_pxl_width58_U0_ap_continue = p_channel_full_n;

assign last_blk_pxl_width58_U0_ap_start = ((ap_sync_reg_last_blk_pxl_width58_U0_ap_ready ^ 1'b1) & ap_start);

assign last_blk_pxl_width58_U0_start_full_n = 1'b1;

assign last_blk_pxl_width58_U0_start_write = 1'b0;

assign ldata1_din = MatStream2AxiStream_U0_ldata1_din;

assign ldata1_write = MatStream2AxiStream_U0_ldata1_write;

assign rows_read = last_blk_pxl_width58_U0_rows_read;

assign streamFlowout_mat_437_read = MatStream2AxiStream_U0_streamFlowout_mat_437_read;

endmodule //pyr_dense_optical_flow_accel_Mat2AxiStream
