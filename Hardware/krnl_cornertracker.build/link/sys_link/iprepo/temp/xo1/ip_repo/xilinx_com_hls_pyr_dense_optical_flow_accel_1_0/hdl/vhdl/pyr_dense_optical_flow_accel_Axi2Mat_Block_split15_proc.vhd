...
entity pyr_dense_optical_flow_accel_Axi2Mat_Block_split15_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pyr_dense_optical_flow_accel_Axi2Mat_Block_split15_proc is 
...
begin
    ...
    ap_return_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, axibound_V_2, ap_return_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= axibound_V_2;
        else 
