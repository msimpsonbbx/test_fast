...
module pyr_dense_optical_flow_accel_Axi2Mat_1 (
        m_axi_gmem1_AWVALID,
        m_axi_gmem1_AWREADY,
        m_axi_gmem1_AWADDR,
        m_axi_gmem1_AWID,
...
wire    Axi2Mat_entry36_U0_ap_start;
wire    Axi2Mat_entry36_U0_ap_done;
wire    Axi2Mat_entry36_U0_ap_continue;
wire    Axi2Mat_entry36_U0_ap_idle;
wire    Axi2Mat_entry36_U0_ap_ready;
wire    Axi2Mat_entry36_U0_start_out;
wire    Axi2Mat_entry36_U0_start_write;
wire    Axi2Mat_entry36_U0_din_read;
wire    Axi2Mat_entry36_U0_rows_read;
wire    Axi2Mat_entry36_U0_cols_read;
wire   [63:0] Axi2Mat_entry36_U0_din_out_din;
wire    Axi2Mat_entry36_U0_din_out_write;
wire   [31:0] Axi2Mat_entry36_U0_rows_out_din;
wire    Axi2Mat_entry36_U0_rows_out_write;
wire   [31:0] Axi2Mat_entry36_U0_cols_out_din;
wire    Axi2Mat_entry36_U0_cols_out_write;
...
wire   [19:0] addrbound_1_U0_return_r;
wire    addrbound_1_U0_return_r_ap_vld;
wire    addrbound_1_U0_rows_read;
wire    addrbound_1_U0_cols_read;
wire   [31:0] addrbound_1_U0_rows_out_din;
wire    addrbound_1_U0_rows_out_write;
wire   [31:0] addrbound_1_U0_cols_out_din;
wire    addrbound_1_U0_cols_out_write;
...
wire   [31:0] Axi2AxiStream_1_U0_m_axi_gmem1_WDATA;
wire   [3:0] Axi2AxiStream_1_U0_m_axi_gmem1_WSTRB;
...
wire   [31:0] Axi2AxiStream_1_U0_ldata1_din;
...
wire   [7:0] AxiStream2MatStream_1_U0_current_img_mat_434_din;
wire    AxiStream2MatStream_1_U0_current_img_mat_434_write;
...
reg   [1:0] Axi2Mat_1_entry3_U0_ap_ready_count;
reg    ap_sync_reg_last_blk_pxl_width_U0_ap_ready;
wire    ap_sync_last_blk_pxl_width_U0_ap_ready;
reg   [1:0] last_blk_pxl_width_U0_ap_ready_count;
reg    ap_sync_reg_Axi2AxiStream_1_U0_ap_ready;
wire    ap_sync_Axi2AxiStream_1_U0_ap_ready;
reg   [1:0] Axi2AxiStream_1_U0_ap_ready_count;
wire   [0:0] start_for_Axi2Mat_entry36_U0_din;
wire    start_for_Axi2Mat_entry36_U0_full_n;
wire   [0:0] start_for_Axi2Mat_entry36_U0_dout;
wire    start_for_Axi2Mat_entry36_U0_empty_n;
wire   [0:0] start_for_addrbound_1_U0_din;
wire    start_for_addrbound_1_U0_full_n;
wire   [0:0] start_for_addrbound_1_U0_dout;
wire    start_for_addrbound_1_U0_empty_n;
...
wire    addrbound_1_U0_start_full_n;
wire    addrbound_1_U0_start_write;
...
#0 Axi2Mat_1_entry3_U0_ap_ready_count = 2'd0;
#0 ap_sync_reg_last_blk_pxl_width_U0_ap_ready = 1'b0;
#0 last_blk_pxl_width_U0_ap_ready_count = 2'd0;
#0 ap_sync_reg_Axi2AxiStream_1_U0_ap_ready = 1'b0;
#0 Axi2AxiStream_1_U0_ap_ready_count = 2'd0;
end

pyr_dense_optical_flow_accel_Axi2Mat_1_entry3 Axi2Mat_1_entry3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_Axi2Mat_entry36 Axi2Mat_entry36_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_last_blk_pxl_width last_blk_pxl_width_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_addrbound_1 addrbound_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_Axi2Mat_Block_split37_proc Axi2Mat_Block_split37_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_Axi2AxiStream_1 Axi2AxiStream_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_AxiStream2MatStream_1 AxiStream2MatStream_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_dense_optical_flow_accel_fifo_w64_d2_S din_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d2_S rows_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d2_S cols_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w64_d4_S din_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w4_d6_S last_blk_width_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w20_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d4_S rows_c15_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d4_S cols_c16_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w20_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_fifo_w32_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_start_for_Axi2Mat_entry36_U0 start_for_Axi2Mat_entry36_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_start_for_addrbound_1_U0 start_for_addrbound_1_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_dense_optical_flow_accel_start_for_AxiStream2MatStream_1_U0 start_for_AxiStream2MatStream_1_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Axi2AxiStream_1_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Axi2AxiStream_1_U0_ap_ready_count <= (Axi2AxiStream_1_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Axi2AxiStream_1_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Axi2AxiStream_1_U0_ap_ready_count <= (Axi2AxiStream_1_U0_ap_ready_count + 2'd1);
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == Axi2Mat_1_entry3_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Axi2Mat_1_entry3_U0_ap_ready_count <= (Axi2Mat_1_entry3_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Axi2Mat_1_entry3_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Axi2Mat_1_entry3_U0_ap_ready_count <= (Axi2Mat_1_entry3_U0_ap_ready_count + 2'd1);
    end
end

always @ (posedge ap_clk) begin
    if (((ap_sync_ready == 1'b1) & (last_blk_pxl_width_U0_ap_ready == 1'b0))) begin
        last_blk_pxl_width_U0_ap_ready_count <= (last_blk_pxl_width_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (last_blk_pxl_width_U0_ap_ready == 1'b1))) begin
        last_blk_pxl_width_U0_ap_ready_count <= (last_blk_pxl_width_U0_ap_ready_count + 2'd1);
    end
end
...
assign Axi2Mat_entry36_U0_ap_continue = 1'b1;

assign Axi2Mat_entry36_U0_ap_start = start_for_Axi2Mat_entry36_U0_empty_n;
...
assign addrbound_1_U0_ap_start = start_for_addrbound_1_U0_empty_n;

assign addrbound_1_U0_start_full_n = 1'b1;

assign addrbound_1_U0_start_write = 1'b0;

assign ap_channel_done_axibound_V = Axi2Mat_Block_split37_proc_U0_ap_done;

assign ap_channel_done_p_channel = addrbound_1_U0_ap_done;

assign ap_done = AxiStream2MatStream_1_U0_ap_done;

assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound_1_U0_ap_idle & AxiStream2MatStream_1_U0_ap_idle & Axi2Mat_entry36_U0_ap_idle & Axi2Mat_Block_split37_proc_U0_ap_idle & Axi2Mat_1_entry3_U0_ap_idle & Axi2AxiStream_1_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_last_blk_pxl_width_U0_ap_ready & ap_sync_Axi2Mat_1_entry3_U0_ap_ready & ap_sync_Axi2AxiStream_1_U0_ap_ready);

assign current_img_mat_434_din = AxiStream2MatStream_1_U0_current_img_mat_434_din;

assign current_img_mat_434_write = AxiStream2MatStream_1_U0_current_img_mat_434_write;
...
assign start_for_Axi2Mat_entry36_U0_din = 1'b1;

assign start_for_AxiStream2MatStream_1_U0_din = 1'b1;

assign start_for_addrbound_1_U0_din = 1'b1;

endmodule //pyr_dense_optical_flow_accel_Axi2Mat_1
