...
module cornerTracker_addrbound (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [21:0] grp_fu_109_p2;
wire   [24:0] shl_ln_fu_85_p3;
wire   [24:0] add_ln976_fu_92_p2;
wire   [10:0] grp_fu_109_p0;
wire   [10:0] grp_fu_109_p1;
reg    grp_fu_109_ce;
reg   [3:0] ap_NS_fsm;
wire   [21:0] grp_fu_109_p00;
wire   [21:0] grp_fu_109_p10;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_CS_fsm_state4)) begin
            return_r_preg <= {{add_ln976_fu_92_p2[24:5]}};
        end
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        return_r = {{add_ln976_fu_92_p2[24:5]}};
    end else begin
...
assign add_ln976_fu_92_p2 = (shl_ln_fu_85_p3 + 25'd31);
...
assign grp_fu_109_p00 = rows_dout;

assign grp_fu_109_p1 = grp_fu_109_p10;

assign grp_fu_109_p10 = cols_dout;

assign rows_out_din = rows_dout;

assign shl_ln_fu_85_p3 = {{grp_fu_109_p2}, {3'd0}};

endmodule //cornerTracker_addrbound
