...
wire    Mat2Axi_entry25_U0_ap_start;
wire    Mat2Axi_entry25_U0_ap_done;
wire    Mat2Axi_entry25_U0_ap_continue;
wire    Mat2Axi_entry25_U0_ap_idle;
wire    Mat2Axi_entry25_U0_ap_ready;
wire    Mat2Axi_entry25_U0_start_out;
wire    Mat2Axi_entry25_U0_start_write;
wire   [63:0] Mat2Axi_entry25_U0_dout_out_din;
wire    Mat2Axi_entry25_U0_dout_out_write;
wire   [21:0] Mat2Axi_entry25_U0_rows_out_din;
wire    Mat2Axi_entry25_U0_rows_out_write;
wire   [31:0] Mat2Axi_entry25_U0_rows_out1_din;
wire    Mat2Axi_entry25_U0_rows_out1_write;
wire   [21:0] Mat2Axi_entry25_U0_cols_out_din;
wire    Mat2Axi_entry25_U0_cols_out_write;
wire   [31:0] Mat2Axi_entry25_U0_cols_out2_din;
wire    Mat2Axi_entry25_U0_cols_out2_write;
...
wire    Mat2Axi_Block_split35_proc_U0_ap_done;
wire    Mat2Axi_Block_split35_proc_U0_ap_continue;
wire    Mat2Axi_Block_split35_proc_U0_ap_idle;
wire    Mat2Axi_Block_split35_proc_U0_ap_ready;
wire   [19:0] Mat2Axi_Block_split35_proc_U0_ap_return;
wire    ap_channel_done_axibound_V;
wire    axibound_V_full_n;
wire    Mat2AxiStream_U0_pyr1_out_mat_432_read;
...
wire   [31:0] AxiStream2Axi_U0_m_axi_gmem2_WDATA;
wire   [3:0] AxiStream2Axi_U0_m_axi_gmem2_WSTRB;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_Mat2Axi_entry25_U0_ap_ready;
wire    ap_sync_Mat2Axi_entry25_U0_ap_ready;
reg   [1:0] Mat2Axi_entry25_U0_ap_ready_count;
...
wire    Mat2Axi_Block_split35_proc_U0_start_full_n;
wire    Mat2Axi_Block_split35_proc_U0_start_write;
...
initial begin
#0 ap_sync_reg_Mat2Axi_entry25_U0_ap_ready = 1'b0;
#0 Mat2Axi_entry25_U0_ap_ready_count = 2'd0;
#0 ap_sync_reg_Mat2AxiStream_U0_ap_ready = 1'b0;
#0 Mat2AxiStream_U0_ap_ready_count = 2'd0;
end

pyr_down_accel_Mat2Axi_entry25 Mat2Axi_entry25_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_down_accel_addrbound addrbound_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_down_accel_Mat2Axi_Block_split35_proc Mat2Axi_Block_split35_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_down_accel_Mat2AxiStream Mat2AxiStream_U0(
...
pyr_down_accel_AxiStream2Axi AxiStream2Axi_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
pyr_down_accel_fifo_w64_d4_S_x dout_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_down_accel_fifo_w22_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_down_accel_fifo_w32_d2_S_x0 rows_c12_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_down_accel_fifo_w22_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_down_accel_fifo_w32_d2_S_x0 cols_c13_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_down_accel_fifo_w20_d2_S_x p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_down_accel_fifo_w20_d2_S_x axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_down_accel_fifo_w32_d2_S_x0 ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pyr_down_accel_start_for_addrbound_U0 start_for_addrbound_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_Mat2Axi_entry25_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_Mat2Axi_entry25_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Mat2Axi_entry25_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Mat2Axi_entry25_U0_ap_ready_count <= (Mat2Axi_entry25_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Mat2Axi_entry25_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Mat2Axi_entry25_U0_ap_ready_count <= (Mat2Axi_entry25_U0_ap_ready_count + 2'd1);
    end
end
...
assign Mat2Axi_Block_split35_proc_U0_ap_continue = axibound_V_full_n;

assign Mat2Axi_Block_split35_proc_U0_ap_start = p_channel_empty_n;

assign Mat2Axi_Block_split35_proc_U0_start_full_n = 1'b1;

assign Mat2Axi_Block_split35_proc_U0_start_write = 1'b0;

assign Mat2Axi_entry25_U0_ap_continue = 1'b1;

assign Mat2Axi_entry25_U0_ap_start = ((ap_sync_reg_Mat2Axi_entry25_U0_ap_ready ^ 1'b1) & ap_start);
...
assign ap_channel_done_axibound_V = Mat2Axi_Block_split35_proc_U0_ap_done;

assign ap_channel_done_p_channel = addrbound_U0_ap_done;

assign ap_done = AxiStream2Axi_U0_ap_done;

assign ap_idle = ((axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & addrbound_U0_ap_idle & Mat2Axi_entry25_U0_ap_idle & Mat2Axi_Block_split35_proc_U0_ap_idle & Mat2AxiStream_U0_ap_idle & AxiStream2Axi_U0_ap_idle);

assign ap_ready = ap_sync_ready;

assign ap_sync_Mat2AxiStream_U0_ap_ready = (ap_sync_reg_Mat2AxiStream_U0_ap_ready | Mat2AxiStream_U0_ap_ready);

assign ap_sync_Mat2Axi_entry25_U0_ap_ready = (ap_sync_reg_Mat2Axi_entry25_U0_ap_ready | Mat2Axi_entry25_U0_ap_ready);

assign ap_sync_continue = ap_continue;

assign ap_sync_done = AxiStream2Axi_U0_ap_done;

assign ap_sync_ready = (ap_sync_Mat2Axi_entry25_U0_ap_ready & ap_sync_Mat2AxiStream_U0_ap_ready);
...
assign pyr1_out_mat_432_read = Mat2AxiStream_U0_pyr1_out_mat_432_read;

assign start_for_addrbound_U0_din = 1'b1;

endmodule //pyr_down_accel_Mat2Axi
