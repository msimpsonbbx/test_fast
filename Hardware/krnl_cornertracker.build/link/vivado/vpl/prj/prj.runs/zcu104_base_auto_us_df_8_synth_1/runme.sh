...
HD_PWD='/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Hardware/krnl_cornertracker.build/link/vivado/vpl/prj/prj.runs/zcu104_base_auto_us_df_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu104_base_auto_us_df_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zcu104_base_auto_us_df_8.tcl
