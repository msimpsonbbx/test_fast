...
set vpl_output_dir "/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Hardware/krnl_cornertracker.build/link/int"
set input_dir "input"
...
set hw_platform_info [dict create \
  ...
  hw_platform_file             "/tools/Xilinx/Vitis/2020.1/platforms/xilinx_zcu104_base_202010_1/hw/xilinx_zcu104_base_202010_1.xsa" \
  hw_platform_part             "xczu7ev-ffvc1156-2-e" \
  hw_platform_vbnv             "xilinx:zcu104:zcu104_base:1.0" \
  bb_locked_dcp                "" \
  ...
  hw_platform_board_part       "xilinx.com:zcu104:part0:1.1" \
  link_output_format           "bitstream" \
  xpfm_file                    "/tools/Xilinx/Vitis/2020.1/platforms/xilinx_zcu104_base_202010_1/xilinx_zcu104_base_202010_1.xpfm" \
...
set config_info [dict create \
  ...
  run_script_map_file      "" \
  clbinary_name            "krnl_cornertracker" \
  kernels                  "cornerTracker pyr_dense_optical_flow_accel pyr_down_accel cornerupdate_accel" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs                  6 \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/tools/Xilinx/Vitis/2020.1/workspace/ip_cache" \
  user_board_repo           {} \
  user_bconn                {} \
  ...
  aie_archive_file         "/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Hardware/krnl_cornertracker.build/link/int/system.aieprj" \
