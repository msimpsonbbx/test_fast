...
set Library     "hls"
set IPName      "cornerupdate_accel"
set Version     "1.0"
set DisplayName "Cornerupdate_accel"
set Revision    "2103251502"
...
set xo_kernel_name "cornerupdate_accel"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Hardware/krnl_cornertracker.build/cornerupdate_accel/cornerupdate_accel/cornerupdate_accel/solution"
set debug_dir "/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Hardware/krnl_cornertracker.build/cornerupdate_accel/cornerupdate_accel/cornerupdate_accel/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {cornerupdate_accel_mul_21s_21s_21_1_1
...
## Variables
set Top "cornerupdate_accel"
set TopNoPrefix "cornerupdate_accel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 list_fix_1 W 0x0 "Data signal of list_fix" {{0 32 list_fix W 0 "Bit 31 to 0 of list_fix"}}} {0x14 list_fix_2 W 0x0 "Data signal of list_fix" {{0 32 list_fix W 0 "Bit 63 to 32 of list_fix"}}} {0x1c list_1 W 0x0 "Data signal of list" {{0 32 list W 0 "Bit 31 to 0 of list"}}} {0x20 list_2 W 0x0 "Data signal of list" {{0 32 list W 0 "Bit 63 to 32 of list"}}} {0x28 nCorners W 0x0 "Data signal of nCorners" {{0 32 nCorners W 0 "Bit 31 to 0 of nCorners"}}} {0x30 flow_vectors_1 W 0x0 "Data signal of flow_vectors" {{0 32 flow_vectors W 0 "Bit 31 to 0 of flow_vectors"}}} {0x34 flow_vectors_2 W 0x0 "Data signal of flow_vectors" {{0 32 flow_vectors W 0 "Bit 63 to 32 of flow_vectors"}}} {0x3c harris_flag W 0x0 "Data signal of harris_flag" {{0 32 harris_flag W 0 "Bit 31 to 0 of harris_flag"}}} {0x44 flow_rows W 0x0 "Data signal of flow_rows" {{0 32 flow_rows W 0 "Bit 31 to 0 of flow_rows"}}} {0x4c flow_cols W 0x0 "Data signal of flow_cols" {{0 32 flow_cols W 0 "Bit 31 to 0 of flow_cols"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem7 m_axi_gmem8 m_axi_gmem9"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem7 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem7"
        data_width "64"
        param_prefix "C_M_AXI_GMEM7"
    ...
    m_axi_gmem8 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem8"
        data_width "32"
        param_prefix "C_M_AXI_GMEM8"
    ...
    m_axi_gmem9 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem9"
        data_width "32"
        param_prefix "C_M_AXI_GMEM9"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 6.667 machine 64 combinational 0 latency 227 II x}
