...
set id 1
set name cornerupdate_accel_mul_21s_21s_21_1_1
...
set id 5
set name cornerupdate_accel_ama_addmuladd_16ns_1ns_11ns_17ns_27_4_1
...
set out_width 27
set exp (i0+i1)*i2+i3
set arg_lists {i0 {16 0 +} i1 {1 0 +} s {17 0 +} i2 {11 0 +} m {27 0 +} i3 {17 0 +} p {27 0 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 6
set name cornerupdate_accel_ama_addmuladd_16ns_1ns_11ns_16ns_27_4_1
set corename simcore_ama
set op ama
set stage_num 4
set max_latency -1
...
set out_width 27
set exp (i0+i1)*i2+i3
set arg_lists {i0 {16 0 +} i1 {1 0 +} s {17 0 +} i2 {11 0 +} m {27 0 +} i3 {16 0 +} p {27 0 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_ama] == "ap_gen_simcore_ama"} {
eval "ap_gen_simcore_ama { \
...
set id 7
set name cornerupdate_accel_mac_muladd_11ns_16ns_17ns_27_4_1
...
set out_width 27
set exp i0*i1+i2
set arg_lists {i0 {11 0 +} i1 {16 0 +} m {27 0 +} i2 {17 0 +} p {27 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 8
set name cornerupdate_accel_mac_muladd_11ns_16ns_16ns_27_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set out_width 27
set exp i0*i1+i2
set arg_lists {i0 {11 0 +} i1 {16 0 +} m {27 0 +} i2 {16 0 +} p {27 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set id 9
set name cornerupdate_accel_mul_mul_16ns_16s_22_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set out_width 22
set exp i0*i1
set arg_lists {i0 {16 0 +} i1 {16 1 +} p {22 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set id 10
set name cornerupdate_accel_mul_mul_16s_16ns_22_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set out_width 22
set exp i0*i1
set arg_lists {i0 {16 1 +} i1 {16 0 +} p {22 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set id 13
set name cornerupdate_accel_mac_muladd_16s_16ns_22s_22_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set out_width 22
set exp i0*i1+i2
set arg_lists {i0 {16 1 +} i1 {16 0 +} m {22 1 +} i2 {22 1 +} p {22 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set id 14
set name cornerupdate_accel_mac_muladd_16ns_16s_22s_22_4_1
set corename simcore_mac
set op mac
set stage_num 4
set max_latency -1
...
set out_width 22
set exp i0*i1+i2
set arg_lists {i0 {16 0 +} i1 {16 1 +} m {22 1 +} i2 {22 1 +} p {22 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_list_fix \
    op interface \
    ports { list_fix { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_flow_vectors_4 \
    op interface \
    ports { flow_vectors_4 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_harris_flag \
    op interface \
    ports { harris_flag { I 1 vector } } \
} "
}
