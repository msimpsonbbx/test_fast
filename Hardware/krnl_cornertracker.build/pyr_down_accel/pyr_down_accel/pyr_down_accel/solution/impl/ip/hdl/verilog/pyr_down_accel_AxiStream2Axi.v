...
module pyr_down_accel_AxiStream2Axi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    dout_blk_n;
reg   [19:0] empty_124_reg_103;
reg    ap_block_state1;
wire   [0:0] icmp_ln882_fu_114_p2;
reg   [63:0] gmem2_addr_reg_165;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((icmp_ln882_reg_161 == 1'd0) & (m_axi_gmem2_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (m_axi_gmem2_AWREADY == 1'b1))) begin
...
always @ (*) begin
    if ((~((icmp_ln882_reg_161 == 1'd0) & (m_axi_gmem2_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((icmp_ln882_reg_161 == 1'd0) & (m_axi_gmem2_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73) & (icmp_ln882_reg_161 == 1'd0))) begin
...
assign add_ln695_fu_149_p2 = (empty_124_reg_103 + 20'd1);
...
always @ (*) begin
    ap_block_state5_io = ((icmp_ln1305_reg_171_pp0_iter1_reg == 1'd0) & (m_axi_gmem2_WREADY == 1'b0));
end

assign ap_block_state5_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state73 = ((icmp_ln882_reg_161 == 1'd0) & (m_axi_gmem2_BVALID == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign icmp_ln1305_fu_144_p2 = ((empty_124_reg_103 == addrbound_V_read) ? 1'b1 : 1'b0);

assign icmp_ln882_fu_114_p2 = ((addrbound_V_read == 20'd0) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_AWADDR = gmem2_addr_reg_165;
...
assign m_axi_gmem2_WDATA = ldata1_read_reg_180;
...
endmodule //pyr_down_accel_AxiStream2Axi
