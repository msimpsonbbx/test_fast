...
entity pyr_down_accel_Mat2AxiStream is
port (
...
architecture behav of pyr_down_accel_Mat2AxiStream is 
...
attribute shreg_extract : string;
    signal last_blk_pxl_width22_U0_ap_start : STD_LOGIC;
    signal last_blk_pxl_width22_U0_ap_done : STD_LOGIC;
    signal last_blk_pxl_width22_U0_ap_continue : STD_LOGIC;
    signal last_blk_pxl_width22_U0_ap_idle : STD_LOGIC;
    signal last_blk_pxl_width22_U0_ap_ready : STD_LOGIC;
    signal last_blk_pxl_width22_U0_return_r : STD_LOGIC_VECTOR (3 downto 0);
    signal last_blk_pxl_width22_U0_return_r_ap_vld : STD_LOGIC;
    signal last_blk_pxl_width22_U0_rows_read : STD_LOGIC;
    signal last_blk_pxl_width22_U0_cols_read : STD_LOGIC;
    signal last_blk_pxl_width22_U0_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal last_blk_pxl_width22_U0_rows_out_write : STD_LOGIC;
    signal last_blk_pxl_width22_U0_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal last_blk_pxl_width22_U0_cols_out_write : STD_LOGIC;
    ...
    signal MatStream2AxiStream_U0_pyr1_out_mat_432_read : STD_LOGIC;
    ...
    signal ap_sync_reg_last_blk_pxl_width22_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_last_blk_pxl_width22_U0_ap_ready : STD_LOGIC;
    signal last_blk_pxl_width22_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    signal last_blk_pxl_width22_U0_start_full_n : STD_LOGIC;
    signal last_blk_pxl_width22_U0_start_write : STD_LOGIC;
    signal MatStream2AxiStream_U0_start_full_n : STD_LOGIC;
    signal MatStream2AxiStream_U0_start_write : STD_LOGIC;

    component pyr_down_accel_last_blk_pxl_width22 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component pyr_down_accel_MatStream2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component pyr_down_accel_fifo_w4_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component pyr_down_accel_fifo_w32_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    last_blk_pxl_width22_U0 : component pyr_down_accel_last_blk_pxl_width22
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => last_blk_pxl_width22_U0_ap_start,
        ap_done => last_blk_pxl_width22_U0_ap_done,
        ap_continue => last_blk_pxl_width22_U0_ap_continue,
        ap_idle => last_blk_pxl_width22_U0_ap_idle,
        ap_ready => last_blk_pxl_width22_U0_ap_ready,
        return_r => last_blk_pxl_width22_U0_return_r,
        return_r_ap_vld => last_blk_pxl_width22_U0_return_r_ap_vld,
        rows_dout => rows_dout,
        rows_empty_n => rows_empty_n,
        rows_read => last_blk_pxl_width22_U0_rows_read,
        cols_dout => cols_dout,
        cols_empty_n => cols_empty_n,
        cols_read => last_blk_pxl_width22_U0_cols_read,
        rows_out_din => last_blk_pxl_width22_U0_rows_out_din,
        rows_out_full_n => rows_c_i_full_n,
        rows_out_write => last_blk_pxl_width22_U0_rows_out_write,
        cols_out_din => last_blk_pxl_width22_U0_cols_out_din,
        cols_out_full_n => cols_c_i_full_n,
        cols_out_write => last_blk_pxl_width22_U0_cols_out_write);

    MatStream2AxiStream_U0 : component pyr_down_accel_MatStream2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        pyr1_out_mat_432_read => MatStream2AxiStream_U0_pyr1_out_mat_432_read,
    ...
    p_channel_U : component pyr_down_accel_fifo_w4_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => last_blk_pxl_width22_U0_return_r,
        if_full_n => p_channel_full_n,
        if_write => last_blk_pxl_width22_U0_ap_done,
        if_dout => p_channel_dout,
        if_empty_n => p_channel_empty_n,
        if_read => MatStream2AxiStream_U0_ap_ready);

    rows_c_i_U : component pyr_down_accel_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => last_blk_pxl_width22_U0_rows_out_din,
        if_full_n => rows_c_i_full_n,
        if_write => last_blk_pxl_width22_U0_rows_out_write,
        if_dout => rows_c_i_dout,
        if_empty_n => rows_c_i_empty_n,
        if_read => MatStream2AxiStream_U0_rows_read);

    cols_c_i_U : component pyr_down_accel_fifo_w32_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => last_blk_pxl_width22_U0_cols_out_din,
        if_full_n => cols_c_i_full_n,
        if_write => last_blk_pxl_width22_U0_cols_out_write,
    ...
    ap_sync_reg_last_blk_pxl_width22_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_last_blk_pxl_width22_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_last_blk_pxl_width22_U0_ap_ready <= ap_const_logic_0;
                else 
                    ap_sync_reg_last_blk_pxl_width22_U0_ap_ready <= ap_sync_last_blk_pxl_width22_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    last_blk_pxl_width22_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (last_blk_pxl_width22_U0_ap_ready = ap_const_logic_0))) then 
                last_blk_pxl_width22_U0_ap_ready_count <= std_logic_vector(unsigned(last_blk_pxl_width22_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (last_blk_pxl_width22_U0_ap_ready = ap_const_logic_1))) then 
                last_blk_pxl_width22_U0_ap_ready_count <= std_logic_vector(unsigned(last_blk_pxl_width22_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    ap_channel_done_p_channel <= last_blk_pxl_width22_U0_ap_done;
    ap_done <= MatStream2AxiStream_U0_ap_done;
    ap_idle <= (last_blk_pxl_width22_U0_ap_idle and (p_channel_empty_n xor ap_const_logic_1) and MatStream2AxiStream_U0_ap_idle);
    ...
    ap_sync_last_blk_pxl_width22_U0_ap_ready <= (last_blk_pxl_width22_U0_ap_ready or ap_sync_reg_last_blk_pxl_width22_U0_ap_ready);
    ap_sync_ready <= (ap_sync_last_blk_pxl_width22_U0_ap_ready and ap_sync_MatStream2AxiStream_U0_ap_ready);
    cols_read <= last_blk_pxl_width22_U0_cols_read;
    last_blk_pxl_width22_U0_ap_continue <= p_channel_full_n;
    last_blk_pxl_width22_U0_ap_start <= ((ap_sync_reg_last_blk_pxl_width22_U0_ap_ready xor ap_const_logic_1) and ap_start);
    last_blk_pxl_width22_U0_start_full_n <= ap_const_logic_1;
    last_blk_pxl_width22_U0_start_write <= ap_const_logic_0;
    ldata1_din <= MatStream2AxiStream_U0_ldata1_din;
    ldata1_write <= MatStream2AxiStream_U0_ldata1_write;
    pyr1_out_mat_432_read <= MatStream2AxiStream_U0_pyr1_out_mat_432_read;
    rows_read <= last_blk_pxl_width22_U0_rows_read;
