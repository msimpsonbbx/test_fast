...
set Library     "hls"
set IPName      "pyr_down_accel"
set Version     "1.0"
set DisplayName "Pyr_down_accel"
set Revision    "2103251501"
...
set xo_kernel_name "pyr_down_accel"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Hardware/krnl_cornertracker.build/pyr_down_accel/pyr_down_accel/pyr_down_accel/solution"
set debug_dir "/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Hardware/krnl_cornertracker.build/pyr_down_accel/pyr_down_accel/pyr_down_accel/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {pyr_down_accel_mul_22s_22s_22_1_1
pyr_down_accel_mul_32s_32s_32_1_1
pyr_down_accel_fifo_w64_d2_S
pyr_down_accel_fifo_w32_d2_S
pyr_down_accel_fifo_w32_d2_S
pyr_down_accel_fifo_w64_d4_S
pyr_down_accel_fifo_w32_d2_S
pyr_down_accel_fifo_w32_d2_S
pyr_down_accel_fifo_w4_d6_S
pyr_down_accel_fifo_w20_d2_S
pyr_down_accel_fifo_w32_d4_S
pyr_down_accel_fifo_w32_d4_S
pyr_down_accel_fifo_w20_d2_S
pyr_down_accel_fifo_w32_d2_S
pyr_down_accel_start_for_Axi2Mat_entry13_U0
pyr_down_accel_start_for_addrbound5_U0
pyr_down_accel_start_for_AxiStream2MatStream_U0
...
pyr_down_accel_fifo_w8_d2_S
pyr_down_accel_fifo_w16_d2_S
pyr_down_accel_fifo_w16_d2_S
pyr_down_accel_fifo_w8_d2_S
pyr_down_accel_fifo_w16_d2_S
pyr_down_accel_fifo_w16_d2_S
pyr_down_accel_start_for_xFPyrDownGaussianBlur_1080_1920_0_1_1_0_5_25_1_U0
pyr_down_accel_start_for_xFpyrDownKernel_1080u_1920u_0u_1u_1_false_Loop_VITIS_LOOP_56_3_procbkb
pyr_down_accel_mul_32ns_32ns_64_1_1
pyr_down_accel_fifo_w4_d2_S
pyr_down_accel_fifo_w32_d2_S_x
pyr_down_accel_fifo_w32_d2_S_x
pyr_down_accel_fifo_w64_d4_S_x
pyr_down_accel_fifo_w22_d2_S
pyr_down_accel_fifo_w32_d2_S_x0
pyr_down_accel_fifo_w22_d2_S
pyr_down_accel_fifo_w32_d2_S_x0
pyr_down_accel_fifo_w20_d2_S_x
pyr_down_accel_fifo_w20_d2_S_x
pyr_down_accel_fifo_w32_d2_S_x0
pyr_down_accel_start_for_addrbound_U0
pyr_down_accel_fifo_w32_d2_S_x1
pyr_down_accel_fifo_w32_d2_S_x1
pyr_down_accel_fifo_w32_d4_S_x
pyr_down_accel_fifo_w32_d4_S_x
pyr_down_accel_fifo_w32_d2_S_x1
pyr_down_accel_fifo_w32_d2_S_x1
pyr_down_accel_fifo_w32_d4_S_x
pyr_down_accel_fifo_w32_d4_S_x
pyr_down_accel_fifo_w64_d2_S_x
pyr_down_accel_fifo_w64_d4_S_x0
pyr_down_accel_fifo_w64_d2_S_x
pyr_down_accel_fifo_w64_d4_S_x0
pyr_down_accel_fifo_w8_d1920_A
pyr_down_accel_fifo_w32_d2_S_x1
pyr_down_accel_fifo_w32_d2_S_x1
pyr_down_accel_fifo_w8_d1920_A
pyr_down_accel_fifo_w8_d1920_A
...
pyr_down_accel_fifo_w32_d2_S_x1
pyr_down_accel_fifo_w8_d1920_A
pyr_down_accel_start_for_xfMat2Array_32_0_1080_1920_1_8_U0
pyr_down_accel_start_for_xfMat2Array_32_0_1080_1920_1_U0
pyr_down_accel_start_for_pyrDown_0_1080_1920_1_false_7_U0
pyr_down_accel_start_for_pyrDown_0_1080_1920_1_false_U0
...
## Variables
set Top "pyr_down_accel"
set TopNoPrefix "pyr_down_accel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 inImgPyr1_1 W 0x0 "Data signal of inImgPyr1" {{0 32 inImgPyr1 W 0 "Bit 31 to 0 of inImgPyr1"}}} {0x14 inImgPyr1_2 W 0x0 "Data signal of inImgPyr1" {{0 32 inImgPyr1 W 0 "Bit 63 to 32 of inImgPyr1"}}} {0x1c outImgPyr1_1 W 0x0 "Data signal of outImgPyr1" {{0 32 outImgPyr1 W 0 "Bit 31 to 0 of outImgPyr1"}}} {0x20 outImgPyr1_2 W 0x0 "Data signal of outImgPyr1" {{0 32 outImgPyr1 W 0 "Bit 63 to 32 of outImgPyr1"}}} {0x28 inImgPyr2_1 W 0x0 "Data signal of inImgPyr2" {{0 32 inImgPyr2 W 0 "Bit 31 to 0 of inImgPyr2"}}} {0x2c inImgPyr2_2 W 0x0 "Data signal of inImgPyr2" {{0 32 inImgPyr2 W 0 "Bit 63 to 32 of inImgPyr2"}}} {0x34 outImgPyr2_1 W 0x0 "Data signal of outImgPyr2" {{0 32 outImgPyr2 W 0 "Bit 31 to 0 of outImgPyr2"}}} {0x38 outImgPyr2_2 W 0x0 "Data signal of outImgPyr2" {{0 32 outImgPyr2 W 0 "Bit 63 to 32 of outImgPyr2"}}} {0x40 pyr_h W 0x0 "Data signal of pyr_h" {{0 32 pyr_h W 0 "Bit 31 to 0 of pyr_h"}}} {0x48 pyr_w W 0x0 "Data signal of pyr_w" {{0 32 pyr_w W 0 "Bit 31 to 0 of pyr_w"}}} {0x50 pyr_out_h W 0x0 "Data signal of pyr_out_h" {{0 32 pyr_out_h W 0 "Bit 31 to 0 of pyr_out_h"}}} {0x58 pyr_out_w W 0x0 "Data signal of pyr_out_w" {{0 32 pyr_out_w W 0 "Bit 31 to 0 of pyr_out_w"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 6.667 machine 64 combinational 0 latency 80 II x}
