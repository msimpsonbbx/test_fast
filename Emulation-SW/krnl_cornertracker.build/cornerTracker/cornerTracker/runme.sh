...
HD_PWD='/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Emulation-SW/krnl_cornertracker.build/cornerTracker/cornerTracker'
cd "$HD_PWD"
...
EAStep vitis_hls -f cornerTracker.tcl -messageDb vitis_hls.pb
