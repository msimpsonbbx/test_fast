...
HD_PWD='/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Emulation-SW/krnl_cornertracker.build/pyr_dense_optical_flow_accel/pyr_dense_optical_flow_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f pyr_dense_optical_flow_accel.tcl -messageDb vitis_hls.pb
