...
HD_PWD='/tools/Xilinx/Vitis/2020.1/workspace/test_fast/Emulation-SW/krnl_cornertracker.build/cornerupdate_accel/cornerupdate_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f cornerupdate_accel.tcl -messageDb vitis_hls.pb
